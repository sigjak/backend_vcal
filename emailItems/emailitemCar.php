...
<body>
  ...
  <table  width="500" style=" border: 1px solid grey;border-radius:5px;  margin-top:20px;"  align="center" cellspacing="0" bgcolor="#E9E9E9"  >
    <tbody >
      ...
      <tr bgcolor="#E9E9E9">
        <td colspan="2" ><h3 style="color: #0E618C; text-align:center;margin-top: 0;">$unit</h3></td>
      </tr>
          <tr bgcolor="#E9E9E9">
      <td colspan="2" style="border-bottom: 2px solid" ><h4 style="color: #ce2029 ; text-align:center;margin-top: 0;">$confirm</h4></td>
    </tr>
      <tr>
